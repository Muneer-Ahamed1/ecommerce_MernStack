...
import { useSelector, useDispatch } from 'react-redux';
 import { selectUserInfo,fetchUserAddressAsync,updateUserAsync } from '../userSlice';
 ...
 export default function UserProfile() {
  ...
  const userInfo = useSelector((state)=>state.User.userAddress);
